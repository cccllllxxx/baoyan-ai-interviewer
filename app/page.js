...
const SAMPLE = `【个人陈述 · 脱敏示例，仅供演示，人物为虚构】

本科就读于北京大学经济学院经济学专业（2022 级，预计 2026 年 6 月毕业），GPA 3.82/4.0，专业排名前 10%。英语 CET-6 632 分，托福 106。修读过计量经济学、金融工程、随机过程、公司金融、时间序列分析等课程。

科研经历：2024.10–2025.05 担任经济学院 X 老师助研，参与「最低工资对就业的因果影响」实证课题，协助完成 CPS 微观数据清洗与稳健性检验，使用 Stata 跑基准回归与工具变量法（用地区间最低工资差异作外生冲击）。成果整理为课程论文，获院级本科生学术论坛二等奖。

课程论文：《基于 Fama-French 五因子的 A 股多因子选股策略实证》——独立构建因子库，做因子合成与 IC 检验，回测 2018–2024 年多空组合年化超额收益 9.2%。

实习经历一：某券商研究所消费组研究实习生（2025.06–2025.09）——参与一项家电、白酒、乳制品三子行业比较研究，负责财务与估值数据处理及部分建模；协助撰写行业周报，跟踪零售终端动销，整理电商大促数据。

实习经历二：某量化私募量化研究实习生（2025.02–2025.05）——协助开发日频量价因子，参与因子去噪与组合优化的部分代码工作。

竞赛：2024 美国大学生数学建模竞赛 M 奖；某量化投资策略大赛全国二十强（2024.06），参与构建多因子选股策略。

技能：Python（pandas / numpy / statsmodels）、Stata、SQL、Matlab，熟悉 Wind / Choice 终端。

研究兴趣与规划：希望硕士阶段聚焦量化金融与资产定价，研究因子模型的市场微观结构解释，未来从事卖方量化研究或买方因子研究。`;
