...
本科就读于北京大学经济学院经济学专业，2022 级，预计 2026 年毕业，GPA 3.7/4.0，专业排名前 15%。

科研经历：参与导师一项关于「最低工资对就业影响」的实证课题（2024.10–2025.05），协助进行数据清洗与稳健性检验，使用 Stata 完成基准回归与工具变量法。

实习经历：在某券商研究所消费行业研究组实习三个月（2025.06–2025.09），参与了一项消费行业比较研究，主要负责数据处理和部分建模工作，整理了家电、白酒、乳制品三个子行业的财务与估值数据，协助撰写行业周报、跟踪零售终端动销。

竞赛：参加某量化投资策略大赛（2024.03–2024.06），参与构建一个多因子选股策略，回测年化收益 18%。

技能：Python（pandas / numpy）、Stata、SQL，英语 CET-6 620 分。

研究兴趣：希望硕士阶段研究量化金融与资产定价，关注因子模型与市场微观结构。`;
